const WhatIsElCol = () => (
  <div id="section-what-is-el-col">
    ...
    <p>
      El Collectooorr does its own research, monitoring and minting. As a user,
      you don’t need to decide what drops to participate in. El Collectooorr
      contains an algorithm to decide whether and at what prices to mint at.
      Moreover, El Collectooorr aims to run continuously at any time of day.
      Lastly, it is designed to try to beat other buyers and bots and buy at a
      good time and price. Put simply, El Collectooorr takes a lot off of your
      plate.
    </p>
    <br />
    ...
    <p>
      ...
      Ethereum mean that art collecting has a high barrier of entry. By enabling
      users to pool their funds, El Collectooorr aims to reduce those barriers.
    </p>
    <br />
    <h3 id="broadening-users-nft-exposure">Broadening users’ NFT exposure:</h3>
    <p>
      Through the fractionalization of NFTs from multiple drops, El Collectooorr
      creates an index of Art Blocks drops. This broadens users’ exposures and
      increases the liquidity of the NFTs in the collections.
    </p>
    <br />
    <br />
    <br />
